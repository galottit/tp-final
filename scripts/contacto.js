...
// Creo las vaiables que voy a guardar
...
document.querySelector("form").addEventListener("submit", (event) => {
    ...
    let blob = new Blob([formularioContacto], {type: "text/plain;charset=utf-8"});
    saveAs(blob, "contact.txt"); //Libreria FileSaver.min.js
})